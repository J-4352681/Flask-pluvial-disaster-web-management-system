...
class ComplaintForm(FlaskForm):
    ...
    category = SelectField("Categoría de la denuncia", choices=[], validators=[DataRequired()], coerce=int)
    assigned_user = SelectField("Usuario asignado a al denuncia", choices=[], validators=[DataRequired()], coerce=int)
