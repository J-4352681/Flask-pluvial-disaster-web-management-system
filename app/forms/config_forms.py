...
class Config_forms(FlaskForm):
    ...
    private_color1 = SelectField("Color Primario de la aplicacion privada", coerce=int, validators=[DataRequired()])
    private_color2 = SelectField("Color Secundario de la aplicacion privada", coerce=int, validators=[DataRequired()])
    private_color3 = SelectField("Color Acento de la aplicacion privada", coerce=int, validators=[DataRequired()])
    #palette_public = SelectMultipleField("Colores de la aplicacion publica, elegir 3", choices=[] , validators=[DataRequired()]) 
    public_color1 = SelectField("Color Primario de la aplicacion publica", coerce=int, validators=[DataRequired()])
    public_color2 = SelectField("Color Secundario de la aplicacion publica", coerce=int, validators=[DataRequired()])
    public_color3 = SelectField("Color Acento de la aplicacion publica", coerce=int, validators=[DataRequired()])
