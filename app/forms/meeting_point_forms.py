...
class MeetingPointModificationForm(FlaskForm):
    ...
    email = EmailField("E-mail", validators=[DataRequired(), Length(1,100,'El email debe de ser de entre 1 y 100 caracteres')]) # , Email()]) # "Install 'email_validator' for email validation support."
